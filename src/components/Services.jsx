      ...
      <div className='max-w-[1172px] mx-auto px-4'>
        ...
        <div className='flex flex-wrap pt-[77px] max-sm:pt-10 -mx-2'>
          {SERVICES_LIST.map((obj, i) => (
            <div className='w-1/3 max-md:w-1/2 max-sm:w-full px-2'>
              <div key={i} className='p-5 relative z-10 transition-all duration-300 border border-transparent hover:border-white hover:border-opacity-10 rounded-xl hover:shadow-[0px_-1px_20px_0px] hover:shadow-lightGray hover:bg-white hover:bg-opacity-10'>
                <div>{obj.icon}</div>
