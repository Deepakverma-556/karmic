    ...
    <div id='home' className='pt-[81px]'>
      <div className='max-w-[1440px] mx-auto relative'>
        ...
        <div className='max-w-[1172px] px-4 mx-auto'>
          ...
          <Description text="We are builders, innovaters, and believers. We believe in a future that rests in your hands, and yours alone. The future is decentralized, The future is web3." myClass="max-w-[532px] mx-auto !leading-6 !text-center" />
