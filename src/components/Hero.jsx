        ...
        <div className='max-w-[1172px] mx-auto px-4 pt-[140px] pb-[139px] max-md:pt-28 max-md:pb-16 max-sm:pb-10'>
          <div className='flex flex-wrap justify-between'>
            <div className='w-7/12 px-3 max-md:w-full'>
              <h1 className='uppercase font-sunflower text-[64px] max-lg:text-[44px] max-sm:text-4xl max-lg:leading-tight font-light leading-[69.56px] text-white'>We are believers decentralization and <span>WEB3.</span></h1>
              ...
              <div className='flex items-center gap-8 max-sm:gap-4'>
                ...
                <CustomButton text="Read More" myClass="px-[32.29px] !font-light !bg-transparent border border-white !text-white" />
              </div>
            </div>
