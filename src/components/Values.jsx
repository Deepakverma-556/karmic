        ...
        <div className='flex flex-wrap pt-[77px] max-sm:pt-10 -mx-2'>
          {VALUES_LIST.map((obj, i) => (
            <div key={i} className='w-1/3 max-md:w-1/2 max-sm:w-full relative group px-2'>
              ...
              <div className='p-5 box-blur transition-all duration-300 border border-gray hover:border-opacity-10 hover:border-white rounded-xl hover:shadow-[0px_-1px_20px_0px] hover:shadow-lightGray hover:bg-white hover:bg-opacity-10'>
                <div>{obj.icon}</div>
