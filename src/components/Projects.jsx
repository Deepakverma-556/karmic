...
const Projects = () => {
    return (
        <div className='bg-whiteLayer bg-cover bg-no-repeat'>
            <div className='max-w-[1172px] mx-auto px-4 pt-[99px] pb-[121px] max-md:pb-20 max-sm:pt-32 max-sm:pb-10'>
                ...
                <Description text="Id nam massa sit ut purus tortor est ultrices nunc. Ipsum, nibh egestas vehicula tellus. Molestie adipiscing diam nibh lectus. Magna id nisl quis vestibulum rhoncus." myClass="max-w-[532px] mx-auto !leading-6 !text-black" />
                ...
                <CustomButton text="View All" myClass="px-[32.07px] !py-[11.34px] !font-medium flex !bg-transparent border border-black hover:!bg-white !mx-auto" />
            </div>
        </div>
    )
}
